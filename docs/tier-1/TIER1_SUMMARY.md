...
| WBS ID | 항목                       | 상태   | 비고                      |
| -----: | -------------------------- | ------ | ------------------------- |
|  T1-00 | 범위/게이트 확정           | 진행중 | 본 문서                   |
|  T1-01 | 토큰 워크스페이스 스켈레톤 | 대기   | packages/tokens 생성      |
|  T1-02 | 토큰 스키마 분리           | 대기   | base/semantic/system      |
|  T1-03 | 토큰 3종 출력              | 대기   | CSS/TS/JSON 빌드          |
|  T1-05 | 테마 스켈레톤              | 대기   | @ara/theme                |
|  T1-06 | 테마 프로필                | 대기   | light/dark/density/radius |

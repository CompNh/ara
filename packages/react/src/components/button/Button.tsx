...
export const Button = forwardRef<ButtonElement, ButtonProps>(function Button(props, ref) {
  ...
  const baseStyle: CSSProperties = {
    ...
    paddingInlineStart: `var(--ara-btn-pl, var(--ara-btn-px, var(--ara-btn-size-${size}-px, ${sizeTokens.paddingInline})))`,
    paddingInlineEnd: `var(--ara-btn-pr, var(--ara-btn-px, var(--ara-btn-size-${size}-px, ${sizeTokens.paddingInline})))`,
    paddingBlockStart: `var(--ara-btn-pt, var(--ara-btn-py, var(--ara-btn-size-${size}-py, ${sizeTokens.paddingBlock})))`,
    paddingBlockEnd: `var(--ara-btn-pb, var(--ara-btn-py, var(--ara-btn-size-${size}-py, ${sizeTokens.paddingBlock})))`,
